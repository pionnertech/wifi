...
CREATE SCHEMA IF NOT EXISTS `db557693269` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci ;
USE `db557693269` ;
...
-- Table `mydb`.`ADMIN`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `db557693269`.`ADMIN` (
  ...
  `ADM_LOCK_STATUS` VARCHAR(45) NULL CHARACTER SET 'utf8' COLLATE 'utf8_spanish_ci' NULL ,
  PRIMARY KEY (`ADM_ID`) )
ENGINE = InnoDB;
...
-- Table `mydb`.`TRAFFIC`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `db557693269`.`TRAFFIC` (
  ...
  `TRAFFICcol` VARCHAR(45) CHARACTER SET 'utf8' COLLATE 'utf8_spanish_ci' NULL ,
  PRIMARY KEY (`TRF_ID`) )
ENGINE = InnoDB;
