...
$queryString = "SELECT TRF_NAME, TRF_OS, TRF_TIME, TRF_GENDER, TRF_LANG, TRF_COUNTRY, TRF_DEVICE, TRF_BROWSER, TRF_PLATFORM FROM TRAFFIC WHERE TRF_FAC_CODE = " . $_SESSION['TxtFacility'];
$query = mysqli_query($datos, $queryString);
...
<div class="cluester" style="min-height: 680px;">                 
           ...
           <!-- aqui va la tabla -->
              <div class="box-body table-responsive">
                                    <table id="example2" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                        <? while($tr = mysqli_fetch_row($query)){ ?>
                                            <tr>
                                                <td><? printf($tr[0]) ?></td>
                                                <td><? printf($tr[1]) ?></td>
                                                <td><? printf($tr[8]) ?></td>
